...
2. Start with the relevant mission file in `missions/`.
3. Use the matching Ralph loop from `scripts/`.
4. Close the loop only after the checklist in `checklists/` is satisfied.
5. Append evidence and next steps to `progress.md`.
